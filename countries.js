...
s_a[252]="Bulawayo|Harare|ManicalandMashonaland Central|Mashonaland East|Mashonaland West|Masvingo|Matabeleland North|Matabeleland South|Midlands";
 ...
 var l_g = new Array();
  l_g[0] = "";
  l_g[1]= "Aba North|Aba South|Arochukwu|Bende|Ikwuano|Isiala-Ngwa North|Isiala-Ngwa South|Isuikwato|Obi Nwa|Ohafia|Osisioma|Ngwa|Ugwunagbo|Ukwa East|Ukwa West|Umuahia North|Umuahia South|Umu-Neochi";
  l_g[2] = "Gwagwalada|Kuje|Abaji|Abuja Municipal|Bwari|Kwali";
  l_g[3] = "Demsa|Fufore|Ganaye|Gireri|Gombi|Guyuk|Hong|Jada|Lamurde|Madagali|Maiha|Mayo-Belwa|Michika|Mubi North|Mubi South|Numan|Shelleng|Song|Toungo|Yola North|Yola South";
  l_g[4] = "Abak|Eastern Obolo|Eket|Esit Eket|Essien Udim|Etim Ekpo|Etinan|Ibeno|Ibesikpo Asutan|Ibiono Ibom|Ika|Ikono|Ikot Abasi|Ikot Ekpene|Ini|Itu|Mbo|Mkpat Enin|Nsit Atai|Nsit Ibom|Nsit Ubium|Obot Akara|Okobo|Onna|Oron|Oruk Anam|Udung Uko|Ukanafun|Uruan|Urue-Offong/Oruko|Uyo";
  l_g[5] = "Aguata|Anambra East|Anambra West|Anaocha|Awka North|Awka South|Ayamelum|Dunukofia|Ekwusigo|Idemili North|Idemili south|Ihiala|Njikoka|Nnewi North|Nnewi South|Ogbaru|Onitsha North|Onitsha South|Orumba North|Orumba South|Oyi";
  l_g[6] = "Alkaleri|Bauchi|Bogoro|Damban|Darazo|Dass|Ganjuwa|Giade|tas/Gadau|Jama'are|Katagum|Kirfi|Misau|Ningi|Shira|Tafawa-Balewa|Toro|Warji|Zaki";
  l_g[7] = "Brass|Ekeremor|Kolokuma/Opokuma|Nembe|Ogbia|Sagbama|Southern Jaw|Yenegoa";
  l_g[8] = "Ado|Agatu|Apa|Buruku|Gboko|Guma|Gwer East|Gwer West|Katsina-Ala|Konshisha|Kwande|Logo|Makurdi|Obi|Ogbadibo|Oju|Okpokwu|Ohimini|Oturkpo|Tarka|Ukum|Ushongo|Vandeikya";
  l_g[9] = "Abadam|Askira/Uba|Bama|Bayo|Biu|Chibok|Damboa|Dikwa|Gubio|Guzamala|Gwoza|Hawul|Jere|Kaga|Kala/Balge|Konduga|Kukawa|Kwaya Kusar|Mafa|Magumeri|Maiduguri|Marte|Mobbar|Monguno|Ngala|Nganzai|Shani";
  l_g[10] = "Akpabuyo|Odukpani|Akamkpa|Biase|Abi|Ikom|Yarkur|Odubra|Boki|Ogoja|Yala|Obanliku|Obudu|Calabar South|Etung|Bekwara|Bakassi|Calabar Municipality";
  l_g[11] = "Oshimili|Aniocha|Aniocha South|Ika South|Ika North-East|Ndokwa West|Ndokwa East|Isoko south|Isoko North|Bomadi|Burutu|Ughelli South|Ughelli North|Ethiope West|Ethiope East|Sapele|Okpe|Warri North|Warri South|Uvwie|Udu|Warri Central|Ukwani|Oshimili North|Patani";
  l_g[12] = "Afikpo South|Afikpo North|Onicha|Ohaozara|Abakaliki|Ishielu|lkwo|Ezza|Ezza South|Ohaukwu|Ebonyi|Ivo";
  l_g[13] = "Esan North-East|Esan Central|Esan West|Egor|Ukpoba|Central|Etsako Central|Igueben|Oredo|Ovia SouthWest|Ovia South-East|Orhionwon|Uhunmwonde|Etsako East|Esan South-East";
  l_g[14] = "Ado|Ekiti-East|Ekiti-West|Emure/Ise/Orun|Ekiti South-West|Ikare|Irepodun|Ijero|Ido/Osi|Oye|Ikole|Moba|Gbonyin|Efon|Ise/Orun|Ilejemeje";
  l_g[15] ="Enugu South|Igbo-Eze South|Enugu North|Nkanu|Udi Agwu|Oji-River|Ezeagu|IgboEze North|Isi-Uzo|Nsukka|Igbo-Ekiti|Uzo-Uwani|Enugu Eas|Aninri|Nkanu East|Udenu";
  l_g[16] = "Akko|Balanga|Billiri|Dukku|Kaltungo|Kwami|Shomgom|Funakaye|Gombe|Nafada/Bajoga|Yamaltu/Delta";
  l_g[17] = "Aboh-Mbaise|Ahiazu-Mbaise|Ehime-Mbano|Ezinihitte|Ideato North|Ideato South|Ihitte/Uboma|Ikeduru|Isiala Mbano|Isu|Mbaitoli|Mbaitoli|Ngor-Okpala|Njaba|Nwangele|Nkwerre|Obowo|Oguta|Ohaji/Egbema|Okigwe|Orlu|Orsu|Oru East|Oru West|Owerri-Municipal|Owerri North|Owerri West";
  l_g[18] = "Auyo|Babura|Birni Kudu|Biriniwa|Buji|Dutse|Gagarawa|Garki|Gumel|Guri|Gwaram|Gwiwa|Hadejia|Jahun|Kafin Hausa|Kaugama Kazaure|Kiri Kasamma|Kiyawa|Maigatari|Malam Madori|Miga|Ringim|Roni|Sule-Tankarkar|Taura|Yankwashi";
  l_g[19] = "Birni-Gwari|Chikun|Giwa|Igabi|Ikara|jaba|Jema'a|Kachia|Kaduna North|Kaduna South|Kagarko|Kajuru|Kaura|Kauru|Kubau|Kudan|Lere|Makarfi|Sabon-Gari|Sanga|Soba|Zango-Kataf|Zaria";
  l_g[20] = "Ajingi|Albasu|Bagwai|Bebeji|Bichi|Bunkure|Dala|Dambatta|Dawakin Kudu|Dawakin Tofa|Doguwa|Fagge|Gabasawa|Garko|Garum|Mallam|Gaya|Gezawa|Gwale|Gwarzo|Kabo|Kano Municipal|Karaye|Kibiya|Kiru|kumbotso|Kunchi|Kura|Madobi|Makoda|Minjibir|Nasarawa|Rano|Rimin Gado|Rogo|Shanono|Sumaila|Takali|Tarauni|Tofa|Tsanyawa|Tudun Wada|Ungogo|Warawa|Wudil|Katsina";
  l_g[21] = "Bakori|Batagarawa|Batsari|Baure|Bindawa|Charanchi|Dandume|Danja|Dan Musa|Daura|Dutsi|Dutsin-Ma|Faskari|Funtua|Ingawa|Jibia|Kafur|Kaita|Kankara|Kankia|Katsina|Kurfi|Kusada|Mai'Adua|Malumfashi|Mani|Mashi|Matazuu|Musawa|Rimi|Sabuwa|Safana|Sandamu|Zango";
  l_g[22] = "Aleiro|Arewa-Dandi|Argungu|Augie|Bagudo|Birnin Kebbi|Bunza|Dandi|Fakai|Gwandu|Jega|Kalgo|Koko/Besse|Maiyama|Ngaski|Sakaba|Shanga|Suru|Wasagu/Danko|Yauri|Zuru";
  l_g[23] = "Adavi|Ajaokuta|Ankpa|Bassa|Dekina|Ibaji|Idah|Igalamela-Odolu|Ijumu|Kabba/Bunu|Kogi|Lokoja|Mopa-Muro|Ofu|Ogori/Mangongo|Okehi|Okene|Olamabolo|Omala|Yagba East|Yagba West";
  l_g[24] = "Asa|Baruten|Edu|Ekiti|Ifelodun|Ilorin East|Ilorin West|Irepodun|Isin|Kaiama|Moro|Offa|Oke-Ero|Oyun|Pategi";
  l_g[25] = "Agege|Ajeromi-Ifelodun|Alimosho|Amuwo-Odofin|Apapa|Badagry|Epe|Eti-Osa|Ibeju/Lekki|Ifako-Ijaye|Ikeja|Ikorodu|Kosofe|Lagos Island|Lagos Mainland|Mushin|Ojo|Oshodi-Isolo|Shomolu|Surulere";
  l_g[26] = "Akwanga|Awe|Doma|Karu|Keana|Keffi|Kokona|Lafia|Nasarawa|Nasarawa-Eggon|Obi|Toto|Wamba";
  l_g[27] = "Agaie|Agwara|Bida|Borgu|Bosso|Chanchaga|Edati|Gbako|Gurara|Katcha|Kontagora|Lapai|Lavun|Magama|Mariga|Mashegu|Mokwa|Muya|Pailoro|Rafi|Rijau|Shiroro|Suleja|Tafa|Wushishi";
  l_g[28] = "Abeokuta North|Abeokuta South|Ado-Odo/Ota|Egbado North|Egbado South|Ewekoro|Ifo|Ijebu East|Ijebu North|Ijebu North East|Ijebu Ode|Ikenne|Imeko-Afon|Ipokia|Obafemi-Owode|Ogun Waterside|Odeda|Odogbolu|Remo North|Shagamu";
  l_g[29] = "Akoko North East|Akoko North West|Akoko South Akure East|Akoko South West|Akure North|Akure South|Ese-Odo|Idanre|Ifedore|Ilaje|Ile-Oluji|Okeigbo|Irele|Odigbo|Okitipupa|Ondo East|Ondo West|Ose|Owo";
  l_g[30] = "Aiyedade|Aiyedire|Atakumosa East|Atakumosa West|Boluwaduro|Boripe|Ede North|Ede South|Egbedore|Ejigbo|Ife Central|Ife East|Ife North|Ife South|Ifedayo|Ifelodun|Ila|Ilesha East|Ilesha West|Irepodun|Irewole|Isokan|Iwo|Obokun|Odo-Otin|Ola-Oluwa|Olorunda|Oriade|Orolu|Osogbo";
  l_g[31] = "Afijio|Akinyele|Atiba|Atigbo|Egbeda|IbadanCentral|Ibadan North|Ibadan North West|Ibadan South East|Ibadan South West|Ibarapa Central|Ibarapa East|Ibarapa North|Ido|Irepo|Iseyin|Itesiwaju|Iwajowa|Kajola|Lagelu Ogbomosho North|Ogbmosho South|Ogo Oluwa|Olorunsogo|Oluyole|Ona-Ara|Orelope|Ori Ire|Oyo East|Oyo West|Saki East|Saki West|Surulere";
  l_g[32] = "Barikin Ladi|Bassa|Bokkos|Jos East|Jos North|Jos South|Kanam|Kanke|Langtang North|Langtang South|Mangu|Mikang|Pankshin|Qua'an Pan|Riyom|Shendam|Wase";
  l_g[33] = "Abua/Odual|Ahoada East|Ahoada West|Akuku Toru|Andoni|Asari-Toru|Bonny|Degema|Emohua|Eleme|Etche|Gokana|Ikwerre|Khana|Obia/Akpor|Ogba/Egbema/Ndoni|Ogu/Bolo|Okrika|Omumma|Opobo/Nkoro|Oyigbo|Port-Harcourt|Tai";
  l_g[34] = "Binji|Bodinga|Dange-shnsi|Gada|Goronyo|Gudu|Gawabawa|Illela|Isa|Kware|kebbe|Rabah|Sabon birni|Shagari|Silame|Sokoto North|Sokoto South|Tambuwal|Tqngaza|Tureta|Wamako|Wurno|Yabo";
  l_g[35] = "Ardo-kola|Bali|Donga|Gashaka|Cassol|Ibi|Jalingo|Karin-Lamido|Kurmi|Lau|Sardauna|Takum|Ussa|Wukari|Yorro|Zing";
  l_g[36] = "Bade|Bursari|Damaturu|Fika|Fune|Geidam|Gujba|Gulani|Jakusko|Karasuwa|Karawa|Machina|Nangere|Nguru Potiskum|Tarmua|Yunusari|Yusufari";
  l_g[37] = "Anka|Bakura|Birnin Magaji|Bukkuyum|Bungudu|Gummi|Gusau|Kaura|Namoda|Maradun|Maru|Shinkafi|Talata Mafara|Tsafe|Zurmi";
 ...
 function populateStates( countryElementId, stateElementId){
   ...
   function populateLocal(countryElementId, stateElementId,localElementId){
	    var selectedCountryIndex = document.getElementById( countryElementId ).selectedIndex;
	     var stateElementIndex = document.getElementById( stateElementId).selectedIndex;
		 var localElement = document.getElementById(localElementId);
		 if(selectedCountryIndex == '169'){
		 localElement.length =0;
		 localElement.options[0] =new Option('Select Local Goverment','');
		 localElement.selectedIndex =0;
		 var local_arr = l_g[stateElementIndex].split("|");
		 for( var i =0;i<local_arr.length;i++){
			 localElement.options[localElement.length] = new Option(local_arr[i],local_arr[i])
		 }
		 
		}
   }
function populateCountries(countryElementId, stateElementId,localElementId) {
	...
	if(localElementId){
		stateElement.onclick = function () {
			populateLocal(countryElementId, stateElementId,localElementId);
		};
	}
